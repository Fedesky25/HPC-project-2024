...
The screen resolution value can be any of the following names, or a custom resolution in the format `<width>x<height>`. Due to `ffmpeg`, width and height must be both multiples of 2.
